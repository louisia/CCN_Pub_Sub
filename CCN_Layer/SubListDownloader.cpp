...
void SubListDownloader::check()
{
    ...
    {
        cerr<<"the pointer of controlpanel in the sublist downloader is null..."<<endl;
        return ;
    }
    ...
    {
        cout<<"@@@@@@@@@@@error message type of the sublistdownloader@@@@@@@@@"<<type<<endl;
        printMsg( msg._buffer, msg._bufferLength );
        cout<<"@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#@#"<<endl;
    }
    ...
    //*/debug
    std::cout<<"SubListDownload receving msg....."<<std::endl;
    printMsg( msg._buffer, msg._bufferLength );
    //*/
